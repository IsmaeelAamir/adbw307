...
public class Level2 extends GameLevel{
    ...
    public Level2(Game game) {
        ...
        try {
            gameMusic = new SoundClip("data/main2.wav");   // Open an audio input stream
        ...
        Shape wall6Shape = new BoxShape(0.35f, 18);
        StaticBody wall6 = new StaticBody(this, wall6Shape);
        wall6.setPosition(new Vec2(-23, -20));
        wall6.rotateDegrees(-45);
    ...
    public void populate(Game game){
        super.populate(game);
        for (int i =0; i < 1000; i++){ WaterPickup waterPickup = new WaterPickup(this);
            waterPickup.setPosition(new Vec2(-50, -i));}
    ...
    public Image paintBackground(){
        Image background = new ImageIcon("data/main3.jpg").getImage();
        return background;
    }
